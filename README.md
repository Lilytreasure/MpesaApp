...
I will be posting a separate project containing an Api ---NOte-- its not the actual MPESA API --iam working on an Api That will help you understand how MPesa Works<br>


 i will be adding more functionalities such as custom fonts and  update the drawables<br>

i am working on an API to integrate in the application follow for more updates<br>

# for API integration some Ui elements  will be stripped to add relevant holders
